...
Zed 支持数百种编程语言与文本格式。
部分语言开箱即用，其他语言需依赖第三方扩展实现。

> 标有 \* 号的语言为 Zed 原生内置支持，无需配置即可使用。
...
- [CFEngine 策略语言](https://github.com/olehermanse/zed-cfengine)
...
- [数据库标记语言 (DBML)](https://github.com/shuklaayush/zed-dbml)
- [Earthfile](https://github.com/glehmann/earthfile.zed)
- [EJS 模板](https://github.com/dangh/zed-ejs)
...
- [PICA200 汇编](https://github.com/Squareheron942/zed-pica200)
